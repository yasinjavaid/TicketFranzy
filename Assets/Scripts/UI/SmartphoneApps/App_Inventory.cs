...
public class App_Inventory : MonoBehaviour
{
    ...
    {
        GameInput.Register("CharacterMove", (int)GameInput.ReferencePriorities.Screen * 2, OnMoveInput);
        GameInput.Register("CameraZoom", (int)GameInput.ReferencePriorities.Screen * 2, OnZoomInput);
        UpdatePrizeList();
        OrderPrizeList();
        UpdatePrizeSlots();
    }
    ...
    {
        GameInput.Deregister("CharacterMove", (int)GameInput.ReferencePriorities.Screen * 2, OnMoveInput);
        GameInput.Deregister("CameraZoom", (int)GameInput.ReferencePriorities.Screen * 2, OnZoomInput);
    }
    ...
    protected virtual void UpdatePrizeList()
        ...
        : PrizeList.All)
            .Where(prize => prize.OwnedAmount > 0)
            .ToList();
